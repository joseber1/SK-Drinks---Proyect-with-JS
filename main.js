...
const cocacola = new Producto ("Cocacola", 250);
...
arrayTicket.forEach(Ticket => {
    ...
    div.innerHTML = `<p class="colorp"> ${Ticket.nombre} </p>
    <p> ${ticket.precio} </p>
    <img src="./images/cocacola.png" class="images-1" alt="cocacola" width="360px" height="200px" >
