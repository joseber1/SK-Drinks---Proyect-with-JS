...
<button id="btn1" class="btn btn-primary" >Haz click1</button>
<button id="btn2" class="btn btn-primary" >Haz click2</button>
`
...
<div id="Formulario"class="Formulario">
          ...
          <form>
                ...
                <br/> <br/>
                <button id="button10" type="submit" class="btn btn-primary">Enviar mensaje</button>
...
let button10 = document.getElementById("submit");
let input2 = document.getElementById("reset");
let input3 = document.getElementById("text3");

input1.addEventListener("message", () => {
console.log(input1.value1)
});

input2.addEventListener("reset", () => {
  console.log(input2.value2)
});


input3.addEventListener("text3", (e) => {
  e.preventDefault();
console.log(input3.value3)
});

button10.addEventListener("submit",  (e) => {
  e.preventDefault();
console.log("Mensaje enviado")
});

input2.onchange = () => {console.log("Su mensaje fue eliminado (Gracias por interactuar con nosotros")};
button10.onchange = () => {console.log("Su mensaje fue enviado exitosamente")};
*/
...
class comprad{
  constructor(nombreCliente, apellidoCliente,NumerodeCompra,Productocomprado) {
 ...
 const formularioo = document.getElementById("formularioo");
 ...
 agregarCompra();
  ...
  const comprad = document.getElementById("comprad").value;
  const Productocomprado = document.getElementById("Productocomprado").value;

  const nuevaCompra = new Productocomprado(nombrec, apellido, comprad, NumerodeCompra,);
  Productocomprado.push(nuevaCompra);
  formularioo.reset();
 ...
 function mostrarCompra () {
  Productocomprado.forEach ( comprad => 
    {
      ...
      <p>Nombre del cliente ${comprad.nombreCliente}</p>
      <p>Apellido Cliente${comprad.apellidoCliente}</p>
      <p>Compra ${comprad.comprad}</p>
      <p>Producto Comprado ${comprad.Productocomprado}</p>
      </div>`;
